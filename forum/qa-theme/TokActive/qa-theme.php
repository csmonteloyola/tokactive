...
class qa_html_theme extends qa_html_theme_base
{
	...
	{
		$jsUrl = $this->rooturl . $this->js_dir . '/tokactive-core.js?' . QA_VERSION;
	...
	public function nav_home()
	{
		$this->output('<div class="qam-main-nav-wrapper clearfix">');
			...
			$this->output('<div class="qa-home-nav-sub-container">');
				$this->logo();
				$this->nav_home_sub();
			$this->output('</div> <!-- END qa-home-nav-sub-container-->');
